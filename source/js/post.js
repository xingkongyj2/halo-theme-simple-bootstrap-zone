...
$(function () {
    ...
    let generateCatalogs = (from, to, marginSpace, success) => {
        ...
        if(minTitleNumber !=0 )
        {
            $('<div class="card-header"><i class="fa fa-book mr-2"></i>文章目录</div>').prependTo($("#card"));                                                                                                           
            $("#catalogBox").addClass("catalogBoxBoder");
        }
        minTitleNumber && (() => {
            // 开始生成目录
            let Level_0_cnt=0,Level_2_cnt=0;
            titles.each(function () {
                ...
                if(titleLevel===0)
                {
                    ...
                    catalogs.append(
                        `<p class='catalog-item'>
                            <a href="javascript:void(0)" style="margin-left: ${titleLevel * marginSpace * 0.4}rem;" data-catalog-target="${$(this).attr('id')}">${Level_0_cnt} ${$(this).text()}</a>
                        </p>`
                    );
                }
                else if(titleLevel===2)
                {
                  ...
                  catalogs.append(
                      `<p class='catalog-item'>
                          <a href="javascript:void(0)" style="margin-left: ${titleLevel * marginSpace * 0.4}rem;" data-catalog-target="${$(this).attr('id')}">${Level_0_cnt}.${Level_2_cnt} ${$(this).text()}</a>
                      </p>`
                  );
                }
